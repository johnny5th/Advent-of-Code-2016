...
function getNextNumber(number, direction) {
  ...
  if(direction == 'U') {
    nextNumber = number - getLevelLength(level+1)+(getLevelLength(level+1) > getLevelLength(level) ? 1 : -1);
    levelCheck = Math.abs(Math.abs(level) - Math.abs(getNumberLevel(nextNumber))) == 1;
  } else if(direction == 'D') {
    nextNumber = number + getLevelLength(level-1)-(getLevelLength(level-1) > getLevelLength(level) ? 1 : -1);
    levelCheck = Math.abs(Math.abs(level) - Math.abs(getNumberLevel(nextNumber))) == 1;
  } else if(direction == 'R') {
